        ...
        <div className='relative w-full flex items-center justify-center'>
            <div
                ...
                <div className='text-center flex items-center gap-2'>
                    ...
                    <a className='text-[22px] raleway' href="/uz">UZ</a>
                </div>
                <div className='w-full flex flex-col text-center gap-5 items-center'>
                    ...
                    <div className='text-center'>
                        ...
                        <p className='hidden lg:block uppercase text-[18px] w-[100%] raleway'>Отправляем на обучение
                            в Китай</p>
                        <p className='hidden lg:block uppercase text-[18px] w-[100%] raleway'>на грантовой
                            основе</p>
                    </div>
                </div>
            </div>
