...
const Instruction = () => {
    return (
        <div className='w-full bg-[#D9D9D9] bg-back md:flex items-center justify-center'
             id='instruction'>
            <div className='w-full md:w-[76%] min-h-[300px] lg:min-h-[400px] flex items-center justify-center relative lg:w-[60%]'>
                <img className='w-[380px] block md:hidden absolute bottom-0 left-0' src={doctor} alt=""/>
                <img className='w-[740px] hidden md:block absolute bottom-0 left-[-50px]' src={doctor2} alt=""/>
