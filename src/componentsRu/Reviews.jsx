        ...
        <div className='p-5 pt-10 relative h-[700px] lg:h-[800px] border-dashed pb-14 border-b-[3px] border-b-[#747474]'
            ...
            <div
                ...
                >
                    <SwiperSlide>
                        <div
                            className='flex gap-4 items-center justify-center flex-col min-w-[300px] lg:min-w-[0px] lg:max-w-[380px]'>
                            <div
                            ...
                            <h3 className='uppercase font-bold way lg:text-[22px] md:text-[24px] text-[#393939]'>Мардиев
                                Алишер</h3>
                            <p className='text-center way lg:text-[14px] md:text-[14px] text-[#393939]'>Наша команда
                                целиком и
                    ...
                    <div
                        ...
                        <h3 className='uppercase font-bold way lg:text-[22px] md:text-[24px] text-[#393939]'>Мардиев
                            Алишер</h3>
                        <p className='text-center way lg:text-[14px] md:text-[14px] text-[#393939]'>Наша команда целиком
                            и
                            полностью состоит из
                            выпускников Китайский ВУЗов, поэтому мы точно знаем про все ньюансы студенческой жизни в
                            Китае</p>
