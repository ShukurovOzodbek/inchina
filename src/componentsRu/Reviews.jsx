                    ...
                    <SwiperSlide>
                        <div className='flex gap-4 min-w-[250px] items-center justify-center flex-col'>
                            <div
                                ...
                                <video className={'w-full h-full rounded-full'} onClick={handleVideoPause} src={video}></video>
                                <svg onClick={handleVideoPlay} className={'absolute cursor-pointer'} width="46" height="52" viewBox="0 0 46 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M41.25 22.1029C44.25 23.8349 44.25 28.1651 41.25 29.8971L9.74999 48.0837C6.75 49.8157 3 47.6506 3 44.1865L3 7.81345C3 4.34936 6.74999 2.1843 9.75 3.91635L41.25 22.1029Z" stroke="white" stroke-opacity="0.62" stroke-width="5"/>
                                </svg>
                            </div>
                            <h3 className='uppercase font-bold way text-[24px]'>Мардиев Алишер</h3>
                            <p className='text-center way'>Наша команда целиком и полностью состоит из
