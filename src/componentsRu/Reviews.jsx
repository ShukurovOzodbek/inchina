...
const Reviews = () => {
    ...
    return (
        <div className='p-5 pt-10 relative h-[700px] lg:h-[800px] border-dashed pb-14 border-b-[3px] border-b-[#747474]' id='reviews'>
            <h2 className='uppercase text-[26px] md:text-[30px] text-center font-[900] lg:text-[40px]'><span className='text-[#B10A17]'>ОТЗЫВЫ</span> СТУДЕНТОВ</h2>
                    ...
                    <SwiperSlide >
                        <div className='flex gap-4 min-w-[250px] items-center justify-center flex-col'>
                            ...
                            <p className='text-center way'>Наша команда целиком и полностью состоит из
                                выпускников Китайский ВУЗов, поэтому мы точно знаем про все ньюансы студенческой жизни в Китае</p>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className='flex gap-4 min-w-[250px] items-center justify-center flex-col'>
