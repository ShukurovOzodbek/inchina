...
const Header2 = () => {
    ...
    return (
        <div
            ...
            id='header'>
            <div className='relative w-full flex items-center justify-center md:min-h-[450px] lg:min-h-[520px]'>
                <div
                    className='w-full text-white right-0 top-0 flex back items-center p-2 flex-col gap-10 pb-[65px] pt-[10px] lg:h-[520px]'>
                    ...
                    <div className='w-full flex flex-col text-center gap-5 items-center pt-[30px]'>
