        ...
        <div className='w-full bg-[#D9D9D9] bg-back md:flex items-center justify-center'
            ...
            <div className='w-full md:w-[76%] min-h-[300px] flex items-center justify-center relative lg:w-[60%]'>
                ...
                <div className={'w-[52%] md:w-[40%] flex flex-col gap-2 absolute right-[20px]'}>
                    ...
                    <p className='text-[14px] w-[99.6%] md:text-[16px] way'>Qanday qilib chet ellik Xitoyda ish topishi mumkin?</p>
                    <button
                        className='rounded-full bg-[#393939] text-white text-[12px] cursor-pointer font-semibold uppercase raleway p-4'>
                        ro'yxatnomani yuklab olish
                    </button>
                </div>
            </div>
        </div>
