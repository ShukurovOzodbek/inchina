...
export const ConsultModal2 = () => {
    ...
    return (
        <div
            ...
            <div
                className='w-[98%] md:w-[60%] lg:w-[40%] rounded-xl relative left-[1%] bg-white p-7 pt-10 flex flex-col gap-4 items-center'>
                ...
                <form onSubmit={handleSubmit} className='w-full flex flex-col gap-4 mt-5 items-center'>
                    ...
                    <div className="flex w-full">
                        ...
                        <input onChange={(e) => setPhoneNumber(e.target.value)} type="phone"
                               ...
                               placeholder="(99) 999-99-99" maxLength="10" required pattern={'[0-9]{2} [0-9]{7}'}/>
                    </div>
                    <button type='submit'
