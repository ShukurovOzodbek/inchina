...
const Questions2 = () => {
    ...
    return (
        <div
            className='w-full relative min-h-[300px] flex flex-col items-center justify-center gap-[30px] p-6 pb-[50px]'
            id='questions'>
            <img className='absolute top-[-210px] left-0' src={p325} alt=""/>
            <h2 className='uppercase text-[24px] md:text-[30px] mt-4 font-bold text-center lg:text-[40px]'>
                KO'P SO'RALADIGAN SAVOLLAR</h2>
                    ...
                    <div className={`rounded-[17px] overflow-hidden ${showAnswer ? "h-auto" : "h-[90px]"} flex flex-col gap-6 justify-between items-start bg-man p-5`}>
                        <div className={'flex'}>
                            <p className='way text-[14px] font-semibold md:text-[16px]'>
                                Xitoyga borish uchun qanday hujjatlarni tayyorlashim kerak?</p>
