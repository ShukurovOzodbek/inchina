...
const Questions2 = () => {
    ...
    return (
        <div
            ...
            <h2 className='uppercase text-[24px] md:text-[30px] mt-4 font-bold text-center lg:text-[40px] mb-[20px] text-[#393939]'>Ko'p beriladigan savollar</h2>
                ...
                <div className={'w-full flex flex-col gap-[7px] md:w-full lg:w-[50%]'}>
                    <div className={`rounded-[17px] overflow-hidden ${showAnswer ? "h-auto" : "h-[90px]"} flex flex-col gap-6 justify-between items-start bg-man p-5`}>
                        <div className={'flex w-full justify-between'}>
                            <p className='way text-[14px] font-semibold md:text-[16px] text-[#393939]'>
