...
const WhyChina2 = () => {
    ...
    return (
        <div className='w-full p-5 relative md:flex items-center justify-center md:py-10 md:whyChina lg:py-[180px]'
             id='whyChina'>
            <div
                ...
                <button onClick={modalOpen}
                        className='w-[85%] lg:w-[45%] rounded-full bg-[#6B941A] text-white text-[12px] cursor-pointer font-semibold uppercase raleway p-4'>Bepul
                    konsultatsiya
                </button>
            </div>
        </div>
