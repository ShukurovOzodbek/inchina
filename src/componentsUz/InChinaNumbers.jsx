    ...
    return (
        <div className='p-5 pt-16 relative md:flex items-center flex-col' id='inNumbers'>
            ...
            <p className='text-center text-[#747474] pt-4 text-[13.8px] lg:w-[60%] way font-[500] leading-[18px] lg:leading-7 md:text-[16px] lg:text-[22px]'>Наша
                ...
                Bizning jamoamiz butunlay Xitoy universitetlari bitiruvchilaridan iborat, shuning uchun biz Xitoydagi talabalar hayotining barcha nuanslari haqida aniq bilamiz.</p>
            <div className='flex flex-wrap lg:flex-nowrap lg:p-5 lg:m-10 lg:mb-[70px] lg:rounded-2xl lg:bg-[#3939390f] gap-2 py-10 md:w-[76%] lg:w-[60%]'>
                <div className='w-[47%] p-3 flex flex-col gap-3 items-center'>
                    ...
                    <div className='flex items-center flex-col gap-2'>
                        <h3 className='flex gap-1 items-end'><span
                            ...
                            className='font-semibold text-[18px]'>yil</span></h3>
